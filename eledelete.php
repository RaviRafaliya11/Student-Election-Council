...
<html>
    ...
    <title>Delete Elections - SEC </title>
...
th {
  ...
  color: white;
    ...
    if($('.checkbox:checked').length > 0){
        var result = confirm("Are you sure to delete selected elections?");
        if(result){
            return true;
        }else{
            return false;
  ...
  crossorigin="anonymous"></script>
      ...
      $(document).ready(function(){
        ...
        <form name="action_form" action="deleelection.php" method="post" onsubmit="return delete_confirm();">
         <table class="table-hover">
              ...
              if(pg_num_rows($run)){
                ...
                while($row=pg_fetch_array($run)){
                 $id=$row['electionid'];
                    ?>
            <tr>
                <td align="center"><input type="checkbox" name="checked_id[]" class="checkbox" value="<?php echo $row['electionid']; ?>"/></td>
            ...
            <br>
<input type="submit" class="btn btn-danger" name="delete_ele" value="DELETE">
        </form>
    </body>
</html>