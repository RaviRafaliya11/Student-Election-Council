...
th {
  ...
  crossorigin="anonymous"></script>
      ...
      $(document).ready(function(){
        ...
        <form name="action_form" action="resultdel.php" method="post" onsubmit="return delete_confirm();">
         <table class="table-hover">
            ...
            <tr>
                ...
                <td><?php echo $row['candidatesnames'];?></td>
                <td><?php echo $row['electionnames'];?></td>
            ...
            <?php
             ...
             ?>
                    ...
                    <br>
<input type="submit" class="btn btn-danger" name="delete_result" value="DELETE">
        </form>
    </body>
</html>